...
insertTable(HCR42_items(function() return SuburbsDistributions["all"]["crate"].items end), crate_items)
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_Farmer"]["items"] end), farmer_items )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_ArmyCamoDesert"]["items"] end), mres )
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_ArmyCamoGreen"]["items"] end), mres )
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_Ghillie"]["items"] end), mres )
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_Survivalist"]["items"] end), mres )
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_Survivalist02"]["items"] end), mres )
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_Survivalist03"]["items"] end), mres )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_Hunter"]["items"] end), binoculars )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_ConstructionWorker"]["items"] end), tools )
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_Foreman"]["items"] end), tools )


local calculator = {
	"Hydrocraft.HCCalculator", 25
}
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_OfficeWorker"]["items"] end), calculator )
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["Outfit_OfficeWorkerSkirt"]["items"] end), calculator )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["bin"]["items"] end), bin_items )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["postbox"]["items"] end), post_box_items )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["metal_shelves"]["items"] end), all_items )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["vendingsnack"]["items"] end), vendingsnack_items )
...
insertInto( HCR42_items(function() return SuburbsDistributions["all"]["vendingpop"]["items"] end), vendingpop_items )

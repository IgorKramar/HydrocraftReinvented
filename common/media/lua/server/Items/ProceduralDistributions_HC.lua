...
-- };
-- insertItemListsInProcDistribution( "WardrobeGeneric", {   wardrobe_items  } );
-- insertItemListsInProcDistribution( "WardrobeClassy", {   wardrobe_items  } );
-- insertItemListsInProcDistribution( "WardrobeGeneric", {   wardrobe_items  } );
-- insertItemListsInProcDistribution( "WardrobeClassy", {   wardrobe_items  } );
...
insertItemListsInProcDistribution( "BakeryMisc", {   bakery_items  } );
...
ProceduralDistributions["list"]["BakeryMisc"].junk = ProceduralDistributions["list"]["BakeryMisc"].junk or { rolls = 1; items = {}}
insertJunkListsInProcDistribution( "BakeryMisc", {   bakery_junk  } );
...
-- insertItemListsInProcDistribution( "FreezerIceCream", {   icecreamkitchen_freezer_items  } );
...
local function OnLoadSpawnGuns()
	...
	if(hcSandbox and hcSandbox.SpawnHydrocraftGuns ~= nil) then
		SPAWN_HC_GUNS = hcSandbox.SpawnHydrocraftGuns

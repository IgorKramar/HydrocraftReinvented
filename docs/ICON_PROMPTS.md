...
а в масштабе. Появился флаг `--align-to`: он находит самую широкую
непрозрачную строку (это и есть основание кашпо), подгоняет под неё масштаб
и совмещает нижний край с референсом. После него у всех состояний одного
растения основание и низ совпадают до пикселя.
...
python3 tools/make_icon.py import --input редис.png \
    ...
    --stretch-v 1.23 --align-to Item_HCPottedradish.png
```
